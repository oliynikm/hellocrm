...
create table interaction (type varchar(31) not null, id bigint not null, description varchar(255), state varchar(255), message blob, client_id bigint, primary key (id));
